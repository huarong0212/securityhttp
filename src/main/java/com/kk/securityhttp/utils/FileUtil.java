...
import com.kk.securityhttp.security.Base64;
...
public class FileUtil {
    ...
    private static String getFileName(String name) {
        return Md5.md5(GoagalInfo.get().uuid + name);
    }
    ...
    ///< 写入字符到sdcard
    public static void writeInfoInSDCard(String result, String dir, String name) {
    ...
    ///< 从sdcard获取图片
    public static Bitmap getImageFromSDCard(String dir, String name) {
        String tmpName = getFileName(name);
