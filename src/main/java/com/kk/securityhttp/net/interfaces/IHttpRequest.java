...
public interface IHttpRequest {
    ...
    Response get(String url, Map<String, String> headers, boolean isEncryptResponse) throws IOException;
    ...
    void aget(String url, Map<String, String> headers, boolean isEncryptResponse, final OnHttpResonseListener
    ...
    Response uploadFile(String url, UpFileInfo2 upFileInfo, Map<String, String> params, boolean
            isEncryptResponse
    ) throws IOException;

    Response uploadFile(String url, UpFileInfo2 upFileInfo, Map<String, String> params, Map<String, String> headers,
                        boolean
                                isEncryptResponse
    ) throws IOException;

    void auploadFile(String url, UpFileInfo2 upFileInfo, Map<String, String> params, boolean
            isEncryptResponse,
                     OnHttpResonseListener
                             httpResonseListener) throws IOException, NullResonseListenerException;

    void auploadFile(String url, UpFileInfo2 upFileInfo, Map<String, String> params, Map<String, String> headers,
                     boolean
            isEncryptResponse,
                     OnHttpResonseListener
                             httpResonseListener) throws IOException, NullResonseListenerException;
